window.addEventListener('DOMContentLoaded', () => {
  ...
  function updateHorairesArrivee() {
    ...
    if (jour==="dimanche")
      fillHours(heureArrivee,chunkArray(horaires.dimanche_arrivee,2));
    else
      fillHours(heureArrivee,chunkArray(horaires[jour],2));
  }
  ...
  function updateHorairesDepart() {
    ...
    if (jour==="dimanche")
      fillHours(heureDepart,chunkArray(horaires.dimanche_depart,2));
    else
      fillHours(heureDepart,chunkArray(horaires[jour],2));
  }
